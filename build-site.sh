...
sphinx-build -a -M html tutorial build
sphinx-build -c tutorial -M html tutorial build index.rst -t OPENXR_MAINSITE -D html_baseurl=https://openxr-tutorial.com/

sphinx-build -a -M html tutorial build/windows/vulkan -t windows -t vulkan -t OPENXR_SUBSITE -D html_baseurl=https://openxr-tutorial.com/ 
sphinx-build -a -M html tutorial build/windows/opengl -t windows -t opengl -t OPENXR_SUBSITE -D html_baseurl=https://openxr-tutorial.com/ 
sphinx-build -a -M html tutorial build/windows/d3d11 -t windows -t d3d11 -t OPENXR_SUBSITE -D html_baseurl=https://openxr-tutorial.com/ 
sphinx-build -a -M html tutorial build/windows/d3d12 -t windows -t d3d12 -t OPENXR_SUBSITE -D html_baseurl=https://openxr-tutorial.com/
